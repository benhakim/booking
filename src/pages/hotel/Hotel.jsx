...
import { faCircleArrowRight, faLocationDot, faCircleXmark, faCircleArrowLeft } from '@fortawesome/free-solid-svg-icons';
    ...
    <div className="hotelWrapper">
      ...
      <h1 className="hotelTitle">Grand Hotel</h1>
        ...
        <span className="hotelPreiceHighlight">
          Book a stay $114 at this property and get a free airport
          taxi
        </span>
